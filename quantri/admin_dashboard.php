...
<li class="nav-item">
    <a class="nav-link" href="quanly_nhanvien.php">
        <i class="fas fa-users"></i>
...
<li class="nav-item">
    <a class="nav-link" href="quanly_lichthue.php">
        <i class="fas fa-users"></i>
...
<li class="nav-item">
    <a class="nav-link" href="quanly_dichvu.php">
        <i class="fas fa-users"></i>
        <span>Quản lý dịch vụ</span>
            ...
            <li class="nav-item">
                <a class="nav-link" href="xem_doanhthu.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="thongke_baocao.php">
